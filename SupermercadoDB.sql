...
CREATE TABLE IF NOT EXISTS `mydb`.`Marca` (
  ...
  PRIMARY KEY (`idMarca`),
  INDEX `fk_Marca_Desconto1_idx` (`idDesconto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Mercadoria` (
  ...
  UNIQUE INDEX `mercadoria_UNICA` (`nome` ASC, `idTipo_mercadoria` ASC, `idMarca` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pagamento` (
  ...
  INDEX `fk_Pagamento_Desconto1_idx` (`idDesconto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Compra` (
  ...
  PRIMARY KEY (`Pagamento_idPagamento`, `Mercadoria_idMercadoria`),
