...
CREATE TABLE IF NOT EXISTS `mydb`.`Sexo` (
  ...
  `descricao` VARCHAR(45) NOT NULL COMMENT 'Masculino ou feminino ou outros',
  PRIMARY KEY (`idSexo`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tipo_telefone` (
  ...
  `descricao` VARCHAR(45) NOT NULL COMMENT 'residencial, pessoal',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tipo_pagamento` (
  ...
  `descricao` VARCHAR(45) NOT NULL COMMENT 'À vista, parcelado',
